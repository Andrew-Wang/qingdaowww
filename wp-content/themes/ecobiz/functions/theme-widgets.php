...
if ( function_exists('register_sidebar') )
  register_sidebar(array(
    ...
    'before_widget' => '<div class="sidebar nospace"><div class="sidebartop"></div><div class="sidebarmain"><div id="%1$s" class="sidebarcontent %2$s">',
...
class OfficeAdress_Widget extends WP_Widget {
  ...
  function widget( $args, $instance ) {
    ...
    if ($contact_title == "") $contact_title =__("Contact Information",'ecobiz');
