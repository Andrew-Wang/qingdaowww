<?php
/*
Template Name: Portfolio 1 Column for Software
*/
?>
<?php get_header();?>
      ...
      <div class="center">
        ...
        <div class="maincontent-full">
          ...
          query_posts(array( 'post_type' => 'portfolio', 'portfolio_category' => 'software', 'showposts' => $portfolio_items_num,'paged'=>$page,"orderby" => $portfolio_order,'order'=> 'ASC'));
