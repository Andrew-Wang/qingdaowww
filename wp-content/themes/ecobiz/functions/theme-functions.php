...
function excerpt_cn($excerpt_length) {
	global $post;
	$content = $post->post_content;
...
function imediapixel_quotebox($text,$custom_link="#") { 
  $out = '<div id="quotebox">';
  $out .= '<a href="'.$custom_link.'"><img src="'.get_template_directory_uri().'/images/mailquote.png" class="alignleft" alt="" /></a>';
  $out .= '<h4>'.stripslashes($text).'</h4>';
  $out .= '</div>';
